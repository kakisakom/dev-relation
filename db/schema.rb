...
ActiveRecord::Schema.define(version: 2021_06_13_072959) do
  ...
  create_table "allowed_sources", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["namespace", "octet1", "octet2", "octet3", "octet4"], name: "index_allowed_sources_on_namespace_and_octet", unique: true
  end
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.index ["birth_mday", "family_name_kana", "given_name_kana"], name: "index_cutomers_on_birth_mday_and_furigana"
    ...
    t.index ["birth_month", "family_name_kana", "given_name_kana"], name: "index_cutomers_on_birth_month_and_furigana"
    ...
    t.index ["birth_year", "family_name_kana", "given_name_kana"], name: "index_cutomers_on_birth_year_and_furigana"
